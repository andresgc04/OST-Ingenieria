      ...
      <section className="py-4">
        <div className="container">
          <Tab.Container
            ...
            defaultActiveKey={"InstalacionesMecanicas"}
          >
            <Row>
              <Col sm={4}>
                <ListGroup>
              ...
              <Col sm={8}>
                <Tab.Content>
                  <Tab.Pane eventKey={"InstalacionesMecanicas"}>
                    ...
                    >
                      Contamos con personal altamente calificado para trabajos
                      de metalmecánica, sistemas de tuberías, instalaciones de
                      ductos, maquinas rotativas y sistemas estáticos como
                      filtros, chimeneas, ciclones, intercambiadores y tanques.
                    </p>
                      ...
                      <Row>
                        <Col xs={5} md={4}>
                          <Image
                            ...
                            src="/resources/InstalacionesMecanicas.jpg"
                            rounded
                          />
                        </Col>
                        ...
                        <Col xs={5} md={4}>
                          <Image
                            style={{ width: "100%", height: "100%" }}
                            src="/resources/InstalacionesMecanicas2.jpg"
                            rounded
                          />
                        </Col>
