...
const InstalacionesElectromecanicas = (props) => {
  return (
    <React.Fragment>
      <Helmet>
        <title>{TITLE}</title>
      ...
      <section className="py-4">
        <div className="container">
          <Tab.Container
            ...
            defaultActiveKey={"InstalacionesElectromecanicas"}
          >
            <Row>
              <Col sm={4}>
                <ListGroup>
                  ...
                  <ListGroup.Item
                    action
                    onClick={() =>
                      props.history.push("/SistemasDeDeteccionDeIncendios")
                    }
                  >
              ...
              <Col sm={8}>
                <Tab.Content>
                  <Tab.Pane eventKey={"InstalacionesElectromecanicas"}>
                    ...
                    >
                      La Ingeniería electromecánica es la aplicación híbrida que
                      surge de la combinación sinérgica de distintas áreas del
                      conocimiento, como el electromagnetismo, la electrónica,
                      la electricidad y la mecánica. Se aplica principalmente en
                      mecanismos eléctricos, máquinas industriales, generación y
                      transformación de energía, que brindamos en nuestro
                      ...
                      <Row>
                        <Col xs={5} md={4}>
                          <Image
                            ...
                            src="/resources/InstalacionesElectromecanicas.jpg"
                            rounded
                          />
                        </Col>
                        ...
                        <Col xs={5} md={4}>
                          <Image
                            style={{ width: "100%", height: "100%" }}
                            src="/resources/InstalacionesElectromecanicas2.jpg"
                            rounded
                          />
                        </Col>
                      </Row>
