                ...
                <div className="container">
                    <Tab.Container id="list-group-tabs-example" defaultActiveKey={'InstalacionesElectromecanicas'}>
                        <Row>
                            <Col sm={4}>
                                <ListGroup>
                                    <ListGroup.Item active action onClick={()=>props.history.push("/InstalacionesElectromecanicas")}>
                                ...
                                <Tab.Content>
                                    <Tab.Pane eventKey={'InstalacionesElectromecanicas'}>
                                        ...
                                        <Container className="mt-3">
                                            <Row>
                                                <Col xs={5} md={4}>
                                                    <Image style={{ width: '100%', height: '100%' }} src={process.env.PUBLIC_URL+"/resources/InstalacionesElectromecanicas.jpg"} rounded />
                                                </Col>
                                                ...
                                                <Col xs={5} md={4}>
                                                    <Image style={{ width: '100%', height: '100%' }} src={process.env.PUBLIC_URL+"/resources/InstalacionesElectromecanicas2.jpg"} rounded />
                                                </Col>
                                            </Row>
                                        </Container>
                                    </Tab.Pane>
