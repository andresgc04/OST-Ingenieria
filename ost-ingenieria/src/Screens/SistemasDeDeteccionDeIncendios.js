      ...
      <section className="py-5">
        <div className="container">
          <Tab.Container
            ...
            defaultActiveKey={"SistemasDeDeteccionDeIncendios"}
          >
            <Row>
              <Col sm={4}>
                <ListGroup>
              ...
              <Col sm={8}>
                <Tab.Content>
                  <Tab.Pane eventKey={"SistemasDeDeteccionDeIncendios"}>
                    ...
                    >
                      Contamos con un personal altamente calificado y con los
                      estudios requeridos para las instalaciones y
                      mantenimientos de estos equipos, así poder proteger a las
                      personas, instalaciones, equipos, bienes y materiales de
                      un entorno de los peligros derivados de un incendio.
                    </p>
                      ...
                      <Row>
                        <Col xs={5} md={4}>
                          <Image
                            ...
                            src="/resources/alarma-incendios.jpg"
                            rounded
                          />
                        </Col>
                        <Col xs={5} md={4}>
                        ...
                        <Col xs={5} md={4}>
                          <Image
                            style={{ width: "100%", height: "60%" }}
                            src="/resources/manilla-alarma.jpg"
                            rounded
                          />
                        </Col>
                      </Row>
