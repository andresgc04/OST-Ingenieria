...
export default function Routes() {
    return <Switch>
        ...
        <Route path="/InstalacionesElectromecanicas" component={InstalacionesElectromecanicas} />
        <Route path="/InstalacionesElectricasServices" component={InstalacionesElectricasServices} />
        <Route path="/InstalacionesMecanicas" component={InstalacionesMecanicas} />
        <Route path="/SistemasDeDeteccionDeIncendios" component={SistemasDeDeteccionDeIncendios} />
